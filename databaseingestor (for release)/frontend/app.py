...
if uploaded_files:
    ...
    try:
        all_sheets_preview = pd.read_excel(first_file, sheet_name=None, nrows=1, header=1) # Header is row 2
        ...
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                try:
                    ...
                    all_sheets = pd.read_excel(uploaded_file, sheet_name=None, header=1) # Start reading data from row 2 (header is row 2)
...
if table_names:
    ...
    if selected_table:
        try:
            ...
            cur = conn.cursor()
            try:
                cur.execute(f"SELECT * FROM {selected_table} LIMIT 20;")
                data = cur.fetchall()
